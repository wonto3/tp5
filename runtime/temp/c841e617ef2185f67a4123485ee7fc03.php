<?php /*a:1:{s:69:"F:\phpStudy\WWW\tp5\public/../application/admin/view\index\index.html";i:1527575828;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="utf-8">
    ...
    <title>后台管理</title>
    <link rel='Shortcut Icon' type='image/x-icon' href='/tp5/public/static/win10/img/windows.ico'>
    <script type="text/javascript" src="/tp5/public/static/win10/js/jquery-2.2.4.min.js"></script>
    <link href="/tp5/public/static/win10/css/animate.css" rel="stylesheet">
    <script type="text/javascript" src="/tp5/public/static/win10/component/layer-v3.0.3/layer/layer.js"></script>
    <link rel="stylesheet" href="/tp5/public/static/win10/component/font-awesome-4.7.0/css/font-awesome.min.css">
    <link href="/tp5/public/static/win10/css/default.css" rel="stylesheet">
    <script type="text/javascript" src="/tp5/public/static/win10/js/win10.js"></script>
    <link href="/tp5/public/static/win10/css/shortcut-drawer.min.css" rel="stylesheet">
    <script type="text/javascript" src="/tp5/public/static/win10/js/shortcut-drawer.min.js"></script>
    <style>
        * {
    ...
    <script>
        Win10.onReady(function () {
            ...
            //设置壁纸
            Win10.setBgUrl({
                main:'/tp5/public/static/win10/img/wallpapers/main.jpg',
                mobile:'/tp5/public/static/win10/img/wallpapers/mobile.jpg',
            });
...
<div id="win10">
    <div class="desktop">
        <div id="win10-shortcuts" class="shortcuts-hidden">
            <div class="shortcut" onclick="Win10.openUrl('http://win10ui.yuri2.cn','<img class=\'icon\' src=\'./img/icon/win10.png\'/>Win10-UI官网')">
                <img class="icon" src="/tp5/public/static/win10/img/icon/win10.png"/>
            ...
            <div class="shortcut" onclick="Win10.openUrl('https://yuri2.cn','<img class=\'icon\' src=\'./img/icon/blogger.png\'/>尤里2号的博客')">
                <img class="icon" src="/tp5/public/static/win10/img/icon/blogger.png"/>
            ...
            <div class="shortcut" onclick="Win10.openUrl('win10ui.yuri2.cn/src/doc.php','<img class=\'icon\' src=\'./img/icon/doc.png\'/>在线文档')">
                <img class="icon" src="/tp5/public/static/win10/img/icon/doc.png"/>
                <div class="title">在线文档</div>
            </div>
            <div class="shortcut" onclick="window.open('https://github.com/yuri2peter/win10-ui')">
                <img class="icon" src="/tp5/public/static/win10/img/icon/github.png"/>
            ...
            <div class="shortcut" onclick="Win10.openUrl('https://www.oschina.net/p/win10-ui','<img class=\'icon\' src=\'./img/icon/kyzg.png\'/>开源中国（求支持~）')">
                <img class="icon" src="/tp5/public/static/win10/img/icon/kyzg.png"/>
                <div class="title">开源中国</div>
            </div>
            <div class="shortcut" onclick="window.open('https://github.com/yuri2peter/win10-ui/archive/master.zip')">
                <img class="icon" src="/tp5/public/static/win10/img/icon/download.png"/>
                <div class="title">快速获取</div>
            </div>
            <div class="shortcut" onclick='Win10.openUrl("<?php echo url('account/index'); ?>","<i class=\"fa fa-user icon black-green\"></i>管理员")'>
            ...
            <div class="shortcut win10-open-window flipInX animated" data-url="http://fly.layui.com/case/2017/top/" style="left: 10px; top: 510px;">
                <i class="icon fa fa-fw fa-thumbs-o-up black-green"></i>
                <div class="title">layui 案例点赞</div>
            </div>
            ...
            <div class="shortcut win10-drawer">
                <img class="icon" src="/tp5/public/static/win10/img/icon/imageres.dll(162).png"/>
                ...
                <div class="win10-drawer-box">
                    ...
                    <div class="shortcut-drawer win10-open-window" data-url="<?php echo url('index/theme'); ?>">
                        <i class="icon fa fa-fw fa-picture-o blue"></i>
                        <div class="title">切换壁纸</div>
                    </div>
                </div>
    ...
    <div id="win10-menu" class="hidden">
        <div class="list win10-menu-hidden animated animated-slideOutLeft">
            ...
            <div class="item" onclick="logout()"><i class="black icon fa fa-power-off fa-fw"></i>退出登录</div>
        </div>
        <div class="blocks">
            <div class="menu_group">
                ...
                <div loc="1,1" size="6,3" class="block">
                    ...
                    <div class="content red cover">
                        <img width="264" style="position: relative;top: -50px;" src="/tp5/public/static/win10/img/presentation/wangyiyun.gif" />
                    </div>
                </div>
            ...
            <div class="menu_group">
                ...
                <div loc="5,2" size="2,2" class="block">
                    <div class="content">
                        <img style="width: 40px;height: 40px;margin: 5px auto;display: block" src="/tp5/public/static/win10/img/icon/baidu.png">
                        <div class="win10-block-content-text">图标按钮</div>
                    </div>
                </div>
                <div loc="1,4" size="6,3" class="block">
                    <div class="content" style="background: url('/tp5/public/static/win10/img/presentation/1.png');background-size: auto">
