<?php /*a:1:{s:69:"F:\phpStudy\WWW\tp5\public/../application/admin/view\login\index.html";i:1527479363;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        #win10-login {
            background: url('/tp5/public/static/win10/img/wallpapers/login.jpg') no-repeat fixed;
            width: 100%;
            height: 100%;
...
<div id="win10-login">
    ...
    <div id="win10-login-box">
        <div class="win10-login-box-square">
            <img src="/tp5/public/static/win10/img/avatar.jpg" class="content"/>
        </div>
